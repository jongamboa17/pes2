            ...
            <div className="py-1 px-5 grid grid-cols-2 gap-x-2 gap-y-3 grid-flow-row-dense">
                ...
                <div className="rounded-lg ">
                    <form action="#" className="py-5">
                        <div class="pb-5">
                            <h2 className=" pl-4 pb-5 font-bold">Seleccione Los Criterios:</h2>
                            {/**Agregar campos */}
                ...
                <div className="rounded-lg min-h-[50px] row-span-2 flex ">
                    <div className=" px-5 grid grid-cols-1 gap-x-2 gap-y-3 grid-flow-row-dense h-20">
                        <form>
                            <div className="py-1 px-5 grid grid-cols-1 gap-x-2 gap-y-3 ">
                    ...
                    <div className=" px-5 grid grid-cols-1 gap-x-2 gap-y-3 grid-flow-row-dense ">
                        <h2 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Criterios Seleccionados:</h2>
                        <ul class="border border-gray-900 rounded-md px-2 h-40 w-70  py-2 overflow-y-auto text-gray-700 dark:text-gray-200">
